...
**v0.1 in progress.** The package is currently a skeleton; `EquipmentAggregator`, `Registry`, the SDK session layer, and the adapter modules move in here from `../api/app/` during PR-2 of the v0.1 restructure. See `.cursor/plans/build_ac-organic-lab-skills_*.plan.md` for the working plan.
