...
|---|---|---|
| `lab-ops@sdl2-server-gaia` (ed25519) | central ops agent — deploy/maintain `sdl-lab-hostops`, incident diagnosis | `sdl2-pc-03-cytation`, 2026-08-11; `sdl2-pc-06-uplc`, 2026-08-11; `sdl2-pc-04` (Gibbie PC), 2026-09-06 — used the same day to install `sdl-lab-hostops` there; the `gibbie-pc` console host resolves through it |
