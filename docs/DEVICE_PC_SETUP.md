...
| `dobot-MG400-server`      | `dobot-mg400`  | 8050 | `run --extra api dobot-mg400-serve` (serves `/status`, `/control/*`, `/graph`, `/ws`, and the operator panel at both `/ui/` and `/web/`) | `sdl2-pc-05-dobot.<tailnet>` (`100.64.254.18`) — Ligand Development Platform PC |
